...
const STRINGS = {
  en: {
    ...
    settingsSaveHint:
      "Theme, developer mode and textures take effect only after Apply settings.",
    settingsDirty:
  ...
  ru: {
    ...
    settingsSaveHint:
      "Тема, режим разработчика и текстуры вступают в силу только после «Применить настройки».",
    settingsDirty:
      "Есть несохранённые изменения — нажмите «Применить настройки»",
  },
};
